...
public class far9blue extends OpMode {
    ...
    // --- POSES (Untouched) ---
    private final Pose startPose = new Pose(57, 9.7, Math.toRadians(90));
    ...
    public void buildPaths() {
        ...
        leavezone = follower.pathBuilder().addPath(
                        new BezierLine(
                                ...
                                new Pose(54.000, 25.000)
                        )
                ).setLinearHeadingInterpolation(Math.toRadians(116), Math.toRadians(133))
