...
@TeleOp(name="solo70ShootingTeleOp", group="TeleOp")
public class solo70ShootingTeleOp extends OpMode {
...
//region Class Methods
    ...
    private void runFlywheel(){
        ...
        flywheel_Left.setPower(flywheelOn ? 0.7 : 0.0);
        flywheel_Right.setPower(flywheelOn ? -0.7 : 0.0);
    }
