...
public class CloseRED extends OpMode {
    ...
    public void buildPaths() {
        shootpreload = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(121.500, 123.500), new Pose(85.500, 87.500))
                )
        ...
        faceartifactsfar = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(85.500, 87.500), new Pose(99.000, 84.00))
                )
        ...
        pickupartifactsfar = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(99.000, 84.00), new Pose(126.000, 84.00))
                )
        ...
        shootartifactsfar = follower
                ...
                .addPath(
                        new BezierCurve(
                                new Pose(126.000, 84.00),
                                new Pose(81.000, 74.500),
                                new Pose(85.500, 87.500)
                        )
                )
        ...
        faceartifactsmiddle = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(85.500, 87.500), new Pose(97.000, 59.2))
                )
                .setLinearHeadingInterpolation(Math.toRadians(47), Math.toRadians(0))
                .build();
        ...
        pickupartifactsmiddle = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(97.000, 59.2), new Pose(134.000, 59.2))
                )
        ...
        shootartifactsmiddle = follower
                ...
                .addPath(
                        new BezierCurve(
                                new Pose(134.000, 59.2),
                                new Pose(81.500, 46.000),
                                new Pose(85.500, 87.500)
                        )
                )
                .setLinearHeadingInterpolation(Math.toRadians(-2), Math.toRadians(47))
                .build();

        facegate = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(85.500, 87.500), new Pose(116.000, 70.500))
                )
                .setLinearHeadingInterpolation(Math.toRadians(47), Math.toRadians(-2))
                .build();
    }
