...
public class Constants {
    public static FollowerConstants followerConstants = new FollowerConstants()
            .mass(11) //write the robot's mass in the parenthesis, in kg
            .forwardZeroPowerAcceleration(-53.8920983536)
            .lateralZeroPowerAcceleration(-77.4741955289)
    ...
    public static MecanumConstants driveConstants = new MecanumConstants()
            .maxPower(1)
            .xVelocity(61.3833964190)
            .yVelocity(50.0809255285)
    ...
    public static PinpointConstants localizerConstants = new PinpointConstants()
            ...
            .strafePodX(-6.59)//Y distance from center of the one that rolls left/right, in inches
